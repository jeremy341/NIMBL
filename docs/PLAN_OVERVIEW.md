...
### Known weaknesses (from `docs/benchmarks/FAILURE_ANALYSIS_LH_MF_SH.md`)
...
### Tier-B final results (`docs/benchmarks/TIER_B_FINAL_RESULTS.md`, run-6/7, git `6c38ad0`)
...
### Failure analysis (`docs/benchmarks/FAILURE_ANALYSIS_LH_MF_SH.md`)
...
## 3. Improvement roadmap (from `docs/benchmarks/IMPROVEMENT_BRAINSTORM_AND_HARNESSES.md`)
...
### Research foundations (`docs/benchmarks/TIER_B_RESEARCH_PAPERS.md`, `docs/benchmarks/BRAINSTORM.md`)
...
### Harness comparison (merged into `docs/benchmarks/IMPROVEMENT_BRAINSTORM_AND_HARNESSES.md`)
...
-  Only 63GB free disk (SWE-bench eval wants ~120GB) → cloud grading preferred
-  PowerShell-only bash tool on win32 → shell backend required
...
| `docs/benchmarks/FAILURE_ANALYSIS_LH_MF_SH.md` | Why lh/mf/sh tasks fail (data-backed) |
| `docs/benchmarks/TIER_B_FINAL_RESULTS.md` | Committed final run results (run-6/7) |
| `docs/benchmarks/TIER_B_RESEARCH_PAPERS.md` | Paper catalog with verified arXiv links |
| `docs/benchmarks/BRAINSTORM.md` | Paper-driven improvement brainstorm |
| `docs/benchmarks/IMPROVEMENT_BRAINSTORM_AND_HARNESSES.md` | 15-harness comparison + brainstorm (HARNESS_COMPARISON.md merged) |
| `docs/benchmarks/IMPROVEMENT_BRAINSTORM_AND_HARNESSES.md` | Combined brainstorm + comparison + unified borrow list |
...
## 6. Claims & honesty rules (from `docs/benchmarks/BENCHMARK_PLAN.md`)
